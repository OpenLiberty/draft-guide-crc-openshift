...
* http://system-route-my-project.apps-crc.testing/system/properties[`http://[system-hostname]/system/properties`^]
* http://inventory-route-my-project.apps-crc.testing/inventory/systems[http\://[inventory-hostname]/inventory/systems^]
